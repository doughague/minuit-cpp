...
#include "minuit-cpp/MnPosDef.hh"
...
FunctionMinimum VariableMetricBuilder::Minimum(const MnFcn& fcn, const GradientCalculator& gc, const MinimumSeed& seed, const MnStrategy& strategy, unsigned int maxfcn, double edmval) const {   
   ...
   // in MinuitCpp edm is correct and is ~ a factor of 2 smaller than F77Minuit
...
#ifdef WARNINGMSG
         MN_INFO_MSG("VariableMetricBuilder: no improvement in line searchh");
#endif
