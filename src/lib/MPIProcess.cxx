// @(#)root/minuit2:$Id: MPIProcess.cxx 29227 2009-06-25 15:22:12Z brun $
// Author: A. Lazzaro 2009
/***************************************************************************
 * Package: MinuitCpp                                                        *
 *    File: $Id: MPIProcess.cxx 29227 2009-06-25 15:22:12Z brun $         *
 *  Author: Alfio Lazzaro, alfio.lazzaro@mi.infn.it                        *
 *                                                                         *
 * Copyright: (C) 2008 by Universita' and INFN, Milan                      *
 ***************************************************************************/

#include "minuit-cpp/MPIProcess.hh"
...
namespace MinuitCpp {
   ...
   bool MPIProcess::SyncVector(MinuitCpp::MnAlgebraicVector &mnvector)
   {
   ...
   bool MPIProcess::SyncSymMatrixOffDiagonal(MinuitCpp::MnAlgebraicSymMatrix &mnmatrix)
   {
