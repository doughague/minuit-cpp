// @(#)root/minuit2:$Id: MnContours.cxx 34256 2010-06-30 21:07:32Z moneta $
...
#include "minuit-cpp/MnFunctionCross.hh"
#include "minuit-cpp/FunctionMinimum.hh"
#include "minuit-cpp/FCNBase.hh"
#include "minuit-cpp/MnCross.hh"
#include "minuit-cpp/MinosError.hh"
#include "minuit-cpp/ContoursError.hh"
...
#ifdef WARNINGMSG
   MN_INFO_MSG("MinuitCpp::MnContour : List of  found points");
   MN_INFO_VAL2("MinuitCpp::MnContour : parameter number x",px);
   MN_INFO_VAL2("MinuitCpp::MnContour : parameter number y",py);
#endif
