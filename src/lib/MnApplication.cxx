// @(#)root/minuit2:$Id: MnApplication.cxx 23654 2008-05-06 07:30:34Z moneta $
...
//       std::cout << "Initial MIGRAD state is " << MnUserParameterState( min.States()[0], min.Up(), min.Seed().Trafo() ) << std::endl;
      ...
      const std::vector<MinuitCpp::MinimumState>& iterationStates =  min.States();
      ...
      for (unsigned int i = 0; i <  iterationStates.size(); ++i) {
         ...
         const MinuitCpp::MinimumState & st =  iterationStates[i];
