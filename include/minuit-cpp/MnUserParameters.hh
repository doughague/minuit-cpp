// @(#)root/minuit2:$Id: MnUserParameters.h 24400 2008-06-20 07:28:49Z moneta $
...
#ifndef MINUITCPP_MnUserParameters
#define MINUITCPP_MnUserParameters
...
/** API class for the user interaction with the parameters;
    ...
    one. The class MinuitCpp::MnUserTransformation is used to keep the 
...
public:
   ...
   const std::vector<MinuitCpp::MinuitParameter>& Parameters() const;
...
#endif  // MINUITCPP_MnUserParameters
