...
#ifndef MINUITCPP_FunctionMinimum
#define MINUITCPP_FunctionMinimum

#include "minuit-cpp/BasicFunctionMinimum.hh"

#ifdef G__DICTIONARY
typedef MinuitCpp::MinimumState MinimumState; 
#endif
...
public:
   ...
   const std::vector<MinuitCpp::MinimumState>& States() const {return fData->States();}
...
#endif  // MINUITCPP_FunctionMinimum
