// @(#)root/minuit2:$Id: MnApplication.h 25486 2008-09-22 12:43:03Z moneta $
...
#ifndef MINUITCPP_MnApplication
#define MINUITCPP_MnApplication
...
/** 
    ...
    Scan)
    User normally instantiates the derived class like MinuitCpp::MnMigrad 
...
// via MnUserParameterState
   ...
   const std::vector<MinuitCpp::MinuitParameter>& MinuitParameters() const;
