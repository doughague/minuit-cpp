// @(#)root/minuit2:$Id: MPIProcess.h 29227 2009-06-25 15:22:12Z brun $
// Author: A. Lazzaro 2009
/***************************************************************************
 * Package: MinuitCpp                                                        *
 *    File: $Id: MPIProcess.h 29227 2009-06-25 15:22:12Z brun $         *
 *  Author: Alfio Lazzaro, alfio.lazzaro@mi.infn.it                        *
 *                                                                         *
 * Copyright: (C) 2008 by Universita' and INFN, Milan                      *
 ***************************************************************************/

#ifndef MINUITCPP_MPIProcess
#define MINUITCPP_MPIProcess
...
namespace MinuitCpp {
   ...
   public:
      ...
      bool SyncVector(MinuitCpp::MnAlgebraicVector &mnvector);  
      bool SyncSymMatrixOffDiagonal(MinuitCpp::MnAlgebraicSymMatrix &mnmatrix);  
